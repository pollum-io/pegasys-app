			...
			{expert && (
				<Flex
					...
					background={[
						...
						`linear-gradient(${theme.bg.candleGraphColor}, ${theme.bg.candleGraphColor}) padding-box, linear-gradient(1deg, rgb(86 190 216 / 97%) 30.76%, rgb(86 190 216 / 40%) 99.76%) border-box`,
					]}
					...
					w={["max-content", "10.3rem", "10.3rem", "10.3rem"]}
