...
export const SettingsButton: FunctionComponent<IButtonProps> = props => {
    ...
    return (
        ...
        <Popover>
            ...
            <PopoverContent left="96rem" top="4rem" w="75%" bgColor={theme.bg.bgPrimary}>
                <PopoverCloseButton />
                <PopoverHeader>
                    <Text fontSize="sm" fontWeight={600}>Transaction Settings</Text>
                </PopoverHeader>
                <PopoverBody>
                    <Text fontSize="sm" fontWeight={400} pb="2">Slippage tolerance</Text>
                    ...
                    <Text fontSize="sm" fontWeight={600} pt="4">Interface Settings</Text>
                    <Flex alignItems="baseline" justifyContent="space-between">
                        <Text fontSize="sm" fontWeight={600} pt="4">Toggle Expert Mode</Text>
                        <Stack align="center" direction="row">
                            <Switch size="md" colorScheme="teal"/>
                        </Stack>
                    </Flex>
                    <Flex alignItems="baseline" justifyContent="space-between">
                        <Text fontSize="sm" fontWeight={600} pt="4">Languages</Text>
                        <Languages />
                    </Flex>
                </PopoverBody>
            </PopoverContent>
