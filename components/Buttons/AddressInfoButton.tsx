            ...
            <ModalContent borderRadius={18} my='40'>
                ...
                <ModalBody bgColor={theme.bg.whiteGray}>
                    ...
                    >
                        ...
                        >
                            <Flex>
                                <Text fontSize='sm' fontWeight={500}>Connected with MetaMask</Text>
                            </Flex>
                            <Flex>
                                <Button
                        ...
                        <Flex mt="2" fontSize="lg" fontWeight={500}>
                            <Flex pr="2" alignItems="center">
                                <Jazzicon diameter={15} seed={Math.round(Math.random() * 10000000)} />
                            </Flex>
                            {shortAddress(account)}
                        </Flex>
                        <Flex flexDirection="row" mt="4"> 
                            <Flex fontSize="sm" color={theme.text.gray} pr='4' flexDirection="row" alignItems="center">
                                <MdOutlineContentCopy/>
                                <Text _hover={{textDecoration: 'underline'}}>Copy Address</Text>
                            </Flex>
                            <Flex fontSize="sm" color={theme.text.gray} flexDirection="row" alignItems="center">
                                <HiExternalLink/>
                                <Text _hover={{textDecoration: 'underline'}}>View on the Explorer</Text>
                            </Flex>
                        </Flex>
                    </Flex>
                </ModalBody>
                <ModalFooter bgColor={theme.bg.iceGray} borderRadius={18} justifyContent="flex-start">
