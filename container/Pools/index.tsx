						...
						>
							...
							>
								...
								<Text
									...
									w={["100%"]}
								>
									We are excited to announce the upgrade of our DeFi protocol
									from v1 on Syscoin to v3 on Rollux! This upgrade brings
									significant enhancements, including robust security measures,
									a suite of new features, an optimized user experience, and a
									brand-new incentives program. To take full advantage of these
									improvements and participate in the new incentives program,
									please migrate your funds from v1 to v3. For any assistance
									with the migration process, our team is available to help you
									on Discord. Join us and make the most of the upgraded
									platform!
								</Text>
							</Flex>
							<Flex
