...
const usePicasso = () => {
	const theme = {
		text: {
			...
			cncWallet: useColorModeValue('#ffffff', '#00d9ef'),
			swapInfo: useColorModeValue('#565a69', '#c3c5cb'),
			cyanPegasys: useColorModeValue('#ffffff', '#00d9ef')
		},
		icon: {
		...
		bg: {
			...
			button: {
				...
				cncWallet: useColorModeValue('#04d3c0', '#153d6f70'),
				slippageSetting: useColorModeValue('#ffffff', '#212429'),
				sysBalance: useColorModeValue('#315df6', 'linear-gradient(128.17deg, rgb(49, 93, 246) -14.78%, rgba(49, 93, 246, 0.2) 110.05%)'),
				psysBalance: useColorModeValue('linear-gradient(128.17deg, rgb(104, 83, 217) -14.78%, rgb(189, 0, 255) 110.05%)', 'linear-gradient(321deg, rgba(104, 83, 217, 0.48) -14.78%, rgb(189, 0, 255) 110.05%)'),
				network: useColorModeValue('#315df6', 'linear-gradient(128.17deg, rgb(49, 93, 246) -14.78%, rgba(49, 93, 246, 0.2) 110.05%)'),
